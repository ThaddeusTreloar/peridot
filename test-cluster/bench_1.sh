...
kafka-topics.sh --bootstrap-server=kafka1:9092 --create --topic inputTopic --partitions 1
kafka-topics.sh --bootstrap-server=kafka1:9092 --create --topic outputTopic --partitions 1
